...
using Laboration4.A;
using Laboration4.A.Utils;

namespace Laboration4.A.TestProject
{
    /// <summary>
    ...
    public class UnitTest
    {
        ...
        public void CheckMakeGuessLow()
        {
            ...
            do
            {
                ...
                sn.Initialize();
                number = (int)GetFieldValue(sn, "_number");
                Assert.IsTrue(number >= 1 && number <= 100, "Initialize(): _number är inte ett tal i intervallet mellan 1 och 100.");
                if (--loopCount == 0)
                {
